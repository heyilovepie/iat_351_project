...
// Source: http://www.java2s.com/Tutorial/Java/0240__Swing/EditorbasedonJTextPane.htm
...
public class TextStyleEditorDemo {
	public TextStyleEditorDemo() {
...
class ForegroundAction extends StyledEditorKit.StyledTextAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (editor == null) {
			JOptionPane.showMessageDialog(null, "You need to select the editor pane before you can change the color.",
